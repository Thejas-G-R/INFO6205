...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    protected static double ordered(int nRuns, int n){
    ...
    protected static double reversed(int nRuns, int n){
    ...
    protected static double partially(int nRuns, int n){
    ...
    protected static double random(int nRuns, int n){
